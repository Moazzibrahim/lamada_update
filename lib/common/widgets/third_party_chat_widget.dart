  ...
  Widget build(BuildContext context) {
    return Consumer<SplashProvider>(
      builder: (context, splashProvider, _) {
        return !(splashProvider.configModel?.maintenanceMode ?? false) && ((splashProvider.configModel?.whatsapp?.status ?? false) && splashProvider.configModel?.whatsapp?.number != null) ?
        InkWell(
          onTap: () async {
