...
class _CheckoutScreenState extends State<CheckoutScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    bool takeAway =
        Provider.of<CheckoutProvider>(context, listen: false).orderType ==
            OrderType.takeAway;
                ...
                SliverToBoxAdapter(child: Consumer<LocationProvider>(
                  ...
                  return Consumer<CheckoutProvider>(
                    ...
                    if (checkoutProvider.orderType == OrderType.delivery
                      ...
                      // checkoutProvider.distance *
                      //     configModel.deliveryManagement!
                      //         .shippingPerKm!; /////////////////
                      if (deliveryCharge <
                ...
                Consumer<CheckoutProvider>(
                  builder: (context, checkoutProvider, _) {
                    double? deliveryCharge = CheckOutHelper.getDeliveryCharge(
                      ...
                      shippingPerKm:
                          configModel.deliveryManagement?.shippingPerKm ?? 0,
                      minShippingCharge:
                          configModel.deliveryManagement?.minShippingCharge ??
                              0,
