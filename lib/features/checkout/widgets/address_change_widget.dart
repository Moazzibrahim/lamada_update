          ...
          child: Column(
            children: [
              locationProvider.addressList == null
                  ? _AddressShimmerWidget(enabled: locationProvider.addressList == null)
                  : (locationProvider.addressList?.isNotEmpty ?? false)
                                              ...
                                              children: [
                                                Padding(
                                                  ...
                                                  child: Icon(
                                                    ...
                                                    color: index == checkoutProvider.addressIndex ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge!.color,
                                                ...
                                                index == checkoutProvider.addressIndex
                                                    ? Align(
                      ...
                      : Column(
                          children: [
                            Text(
                              getTranslated("select_address", context)!,
                              style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                            ),
                            const SizedBox(height: Dimensions.paddingSizeLarge),
                            const CustomAssetImageWidget(Images.selectAddressBottomSheetIcon, height: 180, width: 220, fit: BoxFit.contain),
