            ...
            child: Row(children: [
              ...
              Expanded(
                child: RichText(textAlign : TextAlign.center, text: TextSpan(children: [
                  ...
                  :
                  'you_can_pay_the_full_amount_with_your_wallet', context)!, style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: themeProvider.darkTheme ? Theme.of(context).primaryColor : ColorResources.homePageSectionTitleColor)),

                  const TextSpan(text: ' '),

                  TextSpan(text: getTranslated(isPartialPay ? 'want_to_pay_partially_with_wallet' : 'want_to_pay_via_wallet', context)!,
                    style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).colorScheme.error),),
                ])),
              ),
