    ...
    return Card(
      ...
      child: Column(children: [
        ...
        Container(
          ...
          child: Row(children: [
            Expanded(child: Text(addressModel.addressType!, style: rubikMedium)),
        ...
        Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault), child: Column(children: [
          Row(children: [
            Expanded(flex: 2, child: Text(getTranslated('name', context)!, style: rubikMedium)),
            Expanded(
              flex: 9,
              child: Text(
          ...
          Row(children: [
            Expanded(flex: 2, child: Text(getTranslated('phone', context)!, style: rubikMedium)),
          ...
          Row(children: [
            Expanded(flex: 2, child: Text(getTranslated('address', context)!, style: rubikMedium)),
