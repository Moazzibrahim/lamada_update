                           ...
                           child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min,
                             children: [
                               ...
                               Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center, children: [
                                 ...
                                 Expanded(child: Text(getTranslated('to_pay_offline_you_have_to', context)!, style: rubikMedium.copyWith(
                                   color: Theme.of(context).cardColor
                                 ),)),
                               ]),
                               const SizedBox(height: Dimensions.paddingSizeSmall),
                               ...
                               Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center,children: [
                                 ...
                                 Expanded(child: Text(getTranslated('save_the_necessary_information', context)!, style: rubikMedium.copyWith(
                                     color: Theme.of(context).cardColor
                                 ),)),
                               ]),
                               const SizedBox(height: Dimensions.paddingSizeSmall),
                               ...
                               Row(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.center,children: [
                                 ...
                                 Expanded(child: Text(getTranslated('insert_the_informat', context)!, style: rubikMedium.copyWith(
                                     color: Theme.of(context).cardColor
                                 ),)),
                               ]),
                               const SizedBox(height: Dimensions.paddingSizeSmall),
