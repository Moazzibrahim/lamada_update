    ...
    return Stack(
      children: [
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(
              ...
              child: RichText(textAlign : TextAlign.center, text: TextSpan(children: [
                TextSpan(text: getTranslated('loyalty_point_converted_to', context)!, style: rubikMedium.copyWith(
                  color: Colors.black
                )),
                const TextSpan(text: ' '),
        ...
        Positioned.fill(child: Align(alignment: Alignment.topRight,child: InkWell(
          ...
          child: Padding(
            padding: const EdgeInsets.all(8.0),
            child: Icon(Icons.close, color: Theme.of(context).hintColor.withOpacity(0.7)),
          ),
        ))),
      ],
    );
