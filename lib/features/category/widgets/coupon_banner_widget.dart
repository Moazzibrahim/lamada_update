...
class _CouponBannerWidgetState extends State<CouponBannerWidget> {
  ...
  final CarouselController _subBannerController = CarouselController();
  int _currentIndex = 0;
            ...
            return Container(
              ...
              child: Row(children: [
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Flexible(child: Text(
                    'Enjoy 10% off',
                    style: rubikMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color, fontSize: Dimensions.fontSizeSmall),
