                  ...
                  if(scrollingRate > 0.7)
                    Row(children: [
                      ...
                      Expanded(child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(
                          'Dhanmondi Branch', style: rubikMedium.copyWith(color: Theme.of(context).primaryColor),
                    ...
                    child: Row(children: [
                      ...
                      Padding(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text('20-30 min', style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeSmall , color: Theme.of(context).textTheme.bodyMedium!.color)),
                        ]),
                      ),
                      VerticalDivider(color: Theme.of(context).primaryColor.withOpacity(0.3), thickness: 0.3),
                      ...
                      Padding(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text('20\$', style: rubikMedium.copyWith(fontSize: Dimensions.fontSizeSmall , color: Theme.of(context).textTheme.bodyMedium!.color)),
