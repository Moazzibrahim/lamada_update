        ...
        builder: (context, checkoutProvider, child) {
          return Consumer<CartProvider>(
            builder: (context, cart, child) {
              ...
              bool kmWiseCharge =
                  splashProvider.configModel?.deliveryManagement?.status ??
                      false;
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                          ...
                                                                          style:
                                                                              rubikMedium),
                                                                      const Spacer(),
                                                                      Consumer<CouponProvider>(builder:
                                                                          (context,
                                                                              couponProvider,
                                                                              _) {
                                                                        return couponProvider.coupon !=
                                                                                null
                                                                            ? InkWell(
                                                                                onTap: () {
                                                                            ...
                                                                            : Text(getTranslated(couponProvider.coupon != null ? 'edit' : 'add', context)!,
