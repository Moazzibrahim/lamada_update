  ...
  Widget build(BuildContext context) {
    ...
    return CustomDialogShapeWidget(
        ...
        child: Column(
          ...
          children: [
            const Center(
                child: CustomBottomSheetHeader(showCloseButton: false)),
            const SizedBox(height: Dimensions.paddingSizeDefault),

            Text(getTranslated('to_save_your_order_please_login', context)!,
                style: rubikBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            const SizedBox(height: Dimensions.paddingSizeDefault),

            Text(
              getTranslated(
                  'if_you_want_to_save_your_order_you_need_to_login_first',
                  context)!,
