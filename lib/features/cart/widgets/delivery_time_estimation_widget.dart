      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Row(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(branchProvider.getBranch()?.name ?? '', style: rubikMedium.copyWith(
          ...
          InkWell(
            ...
            child: Text(getTranslated('change', context)!, style: rubikMedium.copyWith(
        ...
        Expanded(child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text('${branchProvider.getBranch()?.preparationTime ?? 0}${getTranslated('min', context)?.toLowerCase()} - ${(branchProvider.getBranch()?.preparationTime ?? 0) + 10}${getTranslated('min', context)?.toLowerCase()}', style: rubikMedium.copyWith(
