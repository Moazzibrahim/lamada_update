...
class HomeScreen extends StatefulWidget {
  ...
  static Future<void> loadData(bool reload, {bool isFcmUpdate = false}) async {
    ...
    if (reload || productProvider.popularLocalProductModel == null) {
      await productProvider.getPopularLocalProductList(1, true,
          isUpdate: false);
    }
          ...
          child: CustomScrollView(controller: _scrollController, slivers: [
                                                      ...
                                                      Text(
                                                        (locationProvider
                                                            ...
                                                            ? locationProvider
                                                                        ...
                                                                        .length >
                                                                    35
                                                                ? '${locationProvider.currentAddress!.substring(0, 35)}...'
                                                                : locationProvider
                                                                    .currentAddress!
                                                            : '',
                        ...
                        child: InkWell(
                          ...
                          child: Container(
                            ...
                            child: Row(children: [
                              ...
                              Expanded(
                                  child: Text(
                                      getTranslated('are_you_hungry', context)!,
                                      style: rubikRegular.copyWith(
                                        color: Theme.of(context).hintColor,
                                      ))),
                            ]),
            ...
            if (isDesktop)
              SliverToBoxAdapter(
                ...
                child: Padding(
                  ...
                  child: SizedBox(
                      /*height: 300,*/ width: Dimensions.webScreenWidth,
                        ...
                        child: Consumer<BannerProvider>(
                          ...
                          return Consumer<CategoryProvider>(
                            ...
                            return Row(
                                ...
                                children: [
                                  (bannerProvider.bannerList?.isEmpty ?? false)
                                      ? const SizedBox()
                                      : (categoryProvider
                                  ...
                                  (categoryProvider.categoryList?.isNotEmpty ??
                                          true)
                                      ? const Expanded(
                                          flex: 4, child: CategoryWebWidget())
                                      : const SizedBox(),
                                ]);
                          });
                        }),
            ...
            SliverToBoxAdapter(child: Consumer<ProductProvider>(
              ...
              return (productProvider
                          .popularLocalProductModel?.products?.isEmpty ??
                      false)
                  ? const SizedBox()
                  : HomeLocalEatsWidget(controller: _localEatsScrollController);
            })),
            ...
            SliverToBoxAdapter(child: Consumer<ProductProvider>(
                builder: (context, productProvider, _) {
              return (productProvider
                          .flavorfulMenuProductMenuModel?.products?.isEmpty ??
                      false)
                  ? const SizedBox()
                  : HomeSetMenuWidget(controller: _setMenuScrollController);
            })),
            ...
            if (isDesktop) ...[
              SliverToBoxAdapter(child: Consumer<ProductProvider>(
                  builder: (context, productProvider, _) {
                return (productProvider
                            .recommendedProductModel?.products?.isEmpty ??
                        false)
                    ? const SizedBox()
            ...
            //                 controller: _branchListScrollController),
            //           ),
            //         ));
            // })),
            ...
            // SliverToBoxAdapter(child: Consumer<ProductProvider>(
            //     builder: (context, productProvider, _) {
            //   return (productProvider.latestProductModel?.products?.isEmpty ??
            //           false)
            //       ? const SizedBox()
            //       : Center(
            //           child: SizedBox(
