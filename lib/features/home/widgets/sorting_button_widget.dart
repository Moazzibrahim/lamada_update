          ...
          PopupMenuButton<ProductSortType>(
            ...
            child: Material(
              ...
              child: Padding(
                ...
                child: CustomAssetImageWidget(
                  Images.sortSvg,
                  width: sortingProvider.viewChangeTo == ViewChangeTo.sortedView ? Dimensions.paddingSizeLarge :  Dimensions.paddingSizeLarge,
                  height: sortingProvider.viewChangeTo == ViewChangeTo.sortedView ? Dimensions.paddingSizeDefault : Dimensions.paddingSizeLarge,
                  color: sortingProvider.viewChangeTo == ViewChangeTo.sortedView ? Theme.of(context).colorScheme.primary : Theme.of(context).hintColor,
                ),
              ),
            ),
          ),
