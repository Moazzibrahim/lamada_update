                ...
                child: Row(children: [
                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Row(mainAxisSize: MainAxisSize.min, children: [
                      Text(getTranslated('order_details', context)!, style: rubikMedium),
                      const SizedBox(width: 50),
                    ]),
                  ])),

                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(getTranslated('quantity', context)!, style: rubikMedium),
                  ])),

                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(getTranslated('estimated_arrival', context)!, style: rubikMedium),
                  ])),

                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(getTranslated('total', context)!, style: rubikMedium),
                  ])),

                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(getTranslated('action', context)!, style: rubikMedium),
                  ])),
                ]),
              ),
