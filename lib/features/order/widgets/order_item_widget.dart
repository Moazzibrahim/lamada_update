                  ...
                  Expanded(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Container(
                          ...
                          child: Text(
                            ...
                            style: rubikMedium.copyWith(color: ColorResources.buttonTextColorMap['${orderItem.orderStatus}'], fontSize: Dimensions.fontSizeSmall),
                          ),
                        ),
                      ]),
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text(getTranslated('estimate_arrival', context)!, style: rubikMedium.copyWith(
                ...
                : Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Expanded(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      ...
                      Text(getTranslated(orderItem.paymentMethod, context) ?? '', style: rubikMedium),
